...
def index(request):
    ...
    return render(request, 'restfuluser_app/index.html', {'all_users': users})

def new(request):
    return render(request, 'restfuluser_app/new.html')
...
def edit(request, user_number):
    ...
    return render(request, 'restfuluser_app/edit.html', {'id': user_number, 'first_name': user_first_name, 'last_name': user_last_name, 'email_address': user_email_address})
...
def show(request, user_number):
    ...
    return render(request, 'restfuluser_app/show.html', {'id': user_number, 'full_name': user_full_name, 'email_address': user_email_address, 'created_at': user_created_at})
